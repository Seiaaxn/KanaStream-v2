...
import { getHistory as getLocalHistory, removeFromHistory, clearHistory } from '../utils/history';
import { useAuth } from '../context/AuthContext';

const HistoryPage = ({ onAnimeSelect }) => {
    const { user, getHistory: getFirebaseHistory } = useAuth();
    ...
    useEffect(() => {
        const loadHist = async () => {
            if (user && getFirebaseHistory) {
                const h = await getFirebaseHistory();
                setHistory(h);
            } else {
