...
const DetailAnime = () => {
    ...
    const handleWatchEpisode = (episode) => {
        ...
        const histItem = {
            id: (detail.url || '') + '::' + (episode.url || ''),
            title: detail.title,
            image: detail.image,
            url: detail.url || window.location.href,
            source: detail.source,
            category: detail.category || 'anime',
        ...
        addToHistory({ title: detail.title, image: detail.image, url: detail.url || window.location.href, source: detail.source, category: detail.category }, { title: episode.title, url: episode.url, episode: episode.number || episode.episode });
        if (saveHistory) saveHistory(histItem);
